...
<head>
    ...
    <link rel="stylesheet" href="estilos-xbox.css">
    <!--fuente logo-->
    ...
    <header>
        ...
        <div class="portada";>   
            <div id = "carrusel-principal"class="owl-carousel owl-theme"">
                ...
                <div id="portada-1">
                    <img src="imagenes/xbox-portada-0.JPG" alt="">
                </div>
    ...
    <section id="populares">
        <div class="contenedor">
            ...
            <div class="seccion-popular" id="xbox-one">
                ...
                <h4>Xbox One</h4>
                <div id ="carrusel-productos-xbox-one-populares" class="owl-carousel owl-theme">
            ...
            <div class="seccion-popular" id="coleccionables">
                ...
                <h4>Más Juegos</h4>
                <div id = "carrusel-productos-xbox-one-no-populares" class="owl-carousel owl-theme">
                 
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-1.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-2.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-3.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-4.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-5.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-6.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-7.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-8.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-9.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
                    ...
                    <div class="item">
                        <div class = "img-producto">
                            <a href="www.google.com"><img src="imagenes/no-populares-xboxone-10.jpg" alt=""></a>
                        </div>
                        <div class="info-producto">
                            <ul>
                                <li>Mario Kart Deluxe 8</li>
...
<script>
    ...
    $('#carrusel-productos-xbox-one-populares').owlCarousel({
        loop:true,
        margin:10,
        nav:true,
        dots:false,
...
<script>
    ...
    $('#carrusel-productos-xbox-one-no-populares').owlCarousel({
        loop:true,
        margin:10,
        nav:true,
        dots:false,
